                                ...
                                self.state.listt.map((item, index) => {
                                    return (
                                        <tr key={item.id}>
                                            ...
                                            <td>{item.maxsize}</td>
                                            <td>
                                                <Button style={{borderColor: "black", backgroundColor: "#4E729A", marginRight: "5px"}}><Link style={{color: "white", marginBottom: "7px", backgroundColor: "#4E729A"}} to={con.projectName + '/group/' + item.id}>Details</Link></Button>
